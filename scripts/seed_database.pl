...
$broker->add_new_source('Uniprot/SWISSPROT','Uniprot',1,'Bio::EnsEMBL::Versioning::Pipeline::Downloader::UniProtSwissProt','Bio::EnsEMBL::Mongoose::Parser::Swissprot');
...
$broker->add_new_source('Uniprot/SPTREMBL','Uniprot',1,'Bio::EnsEMBL::Versioning::Pipeline::Downloader::UniProtTrembl','Bio::EnsEMBL::Mongoose::Parser::Swissprot');
